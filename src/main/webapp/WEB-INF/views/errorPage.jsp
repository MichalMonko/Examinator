...
<div class="container-fluid text-white text-center">
    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <h2><strong>Wystąpił błąd!</strong></h2>
            <br>
            <h4><strong>Kod Błędu: </strong> ${errorCode} </h4>
            <br>
            <h4><strong>Wiadomość: </strong> ${errorMessage}</h4>
            <br>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <br>
            <a class="btn btn-primary btn-block" href="/">Kliknij tutaj aby powrócić do strony głównej</a></p>
        </div>
